  ...
  <div class="flex gap-3 mt-10">
    ...
    >
      ...
      <div class="opacity-60">
        ...
        <p>
          Każdą osobę traktuję indywidualnie. Poprzez przeprowadzony wywiad
          dobieram zabieg odpowiedni do oczekiwań pacjenta tak aby czuł się w
          pełni zaopiekowany.Wykorzystanie swoje sposoby, moje techniki pomogą
          każdemu na codzienne dobre uczucie. W każdy masaż wkładam swoją
          energię, wysiłek i serce, aby klient czuł się lepiej.
        </p>
        <p>Do zobaczenia na masażu :)</p>
      </div>
    </div>
  </div>
</template>
